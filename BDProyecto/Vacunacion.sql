...
insert into Enfermedades values (16, 'Ninguno');
...
insert into Preguntas values (2, 'Cual es tu banda favorita?')
insert into Preguntas values (3, 'Cual es tu animal favorito?')
